...
function App() {
  ...
  return (
    <main className="portfolio-shell">
      ...
      >
        <div className="planet-preview-shell planet-preview-static" role="region" aria-label="Life On Our Planet atlas preview">
          <a className="planet-preview-image-link" href={lifeProject.liveUrl} target="_blank" rel="noreferrer">
            <img
              src={lifeProject.imageUrl}
              alt="Static preview of the Life On Our Planet atlas interface"
              className="planet-preview-image"
            />
          </a>
